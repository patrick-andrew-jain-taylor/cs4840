...
#define DRIVER_NAME "miner_driver"

struct miner_dev {
	struct resource res; /* Resource: our registers */
	void __iomem *virtbase; /* Where registers can be accessed in memory */
	uint8_t segments[DATA_SIZE];
} dev;

static void write_digit(int digit, uint8_t segments)
{
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Half-Fast Bitcoin Group");
MODULE_DESCRIPTION("FPGA Miner");
