...
set tmp [master_read_memory $m $bitcoin_miner 96]
puts "Before write: $tmp"

# Write a test pattern to the various registers
#$vga_led is the base address which was set above in the first line
foreach {r v} {95 0x00 94 0x00 93 0x02 92 0x80 91 0x00 90 0x00 89 0x00 88 0x00 87 0x00 86 0x00 85 0x00 84 0x00 83 0x00 82 0x00 81 0x00 80 0x00 79 0x00 78 0x00 77 0x00 76 0x00 75 0x00 74 0x00 73 0x00 72 0x00 71 0x00 70 0x00 69 0x00 68 0x00 67 0x00 66 0x00 65 0x00 64 0x00 63 0x00 62 0x00 61 0x00 60 0x00 59 0x00 58 0x00 57 0x00 56 0x00 55 0x00 54 0x00 53 0x00 52 0x00 51 0x80 50 0x00 49 0x00 48 0x00 47 0x0e 46 0x33 45 0x32 44 0x7a 43 0x21 42 0x94 41 0x26 40 0x1a 39 0x93 38 0x95 37 0xe6 36 0x4d 35 0xbe 34 0xd1 33 0x71 32 0x15 31 0x22 30 0x8e 29 0xa4 28 0x73 27 0x2a 26 0x3c 25 0x9b 24 0xa8 23 0x60 22 0xc0 21 0x09 20 0xcd 19 0xa7 18 0x25 17 0x2b 16 0x91 15 0x61 14 0xa5 13 0xe7 12 0x5e 11 0xc8 10 0xc5 9 0x82 8 0xa5 7 0xf1 6 0x06 5 0xab 4 0xb3 3 0xaf 2 0x41 1 0xf7 0 0x90} {
    master_write_8 $m [expr $bitcoin_miner + $r] $v
    master_read_8 $m [expr $bitcoin_miner + $r] 1
#}
...
set tmp [master_read_8 $m $bitcoin_miner 0x80]
